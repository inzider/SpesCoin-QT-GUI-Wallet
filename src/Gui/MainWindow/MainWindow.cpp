...
//
// SpesCoin is free software: you can redistribute it and/or modify
...
const char REPORT_ISSUE_URL[] = "https://myspes.org";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("SPES Wallet %1").arg(Settings::instance().getVersion()));
